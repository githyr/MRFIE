...
class FlowerAttrData(object):
    """
        Dataloader for Caltech101 datasets
    """

    def __init__(self, data_dir='Flower-3.mat',
                 mode='train'):

        super(FlowerAttrData, self).__init__()
...
if __name__ == '__main__':
    trainset = FlowerAttrData(
        data_dir='/mnt/3443FB571902BBEE/hyr/PycharmProject/MvNNcor_/mvdata/Caltech101-20-3.mat',
        mode='train')
    ...
    for index, (idx, sample_set, sample_targets) in enumerate(train_loader):
        ...
        scio.savemat('Caltech20-3train.mat', {'view1': sample_set[0].detach().cpu().numpy(), \
